...
<html lang="en">
  ...
  <!--END MENU-->
    ...
    <div class="p-3">
      <h1>Editar Album</h1>
      <form class="" action="{base_url}/disco/public/AlbumController/update" method="post">
        <!--Nombre Album-->
        <div class="form-group">
          <label for="nameAlbum">Nombre Album:</label>
          <input type="text" name="input_nameAlbum" id="nameAlbum" class="form-control" value="{name}" minlength="3" maxlength="255" required >
        </div>
        <!--Author-->
        <div class="form-group">
          <label for="nameAuthor">Nombre Autor:</label>
          <input type="text" name="input_nameAuthor" id="nameAuthor" class="form-control" value="{author}" minlength="3" maxlength="255" required>
        </div>
        <!--Genero ID-->
        <div class="form-group">
          <label for="idGnre">Genero ID:</label>
          <input type="text" name="input_idGnre" id="idGnre" class="form-control" value="{genre_id}" minlength="3" maxlength="255" required>
